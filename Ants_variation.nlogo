...
This is a basic virtual ant ("vant") model.  It shows how extremely simple deterministic rule can result in a complex behavior.  It also demonstrates the concept of time reversibility and shows that time reversibility is not incompatible with complex behavior.

## HOW IT WORKS

The world is a grid of patches.  Each patch can adopt one of five possible states.  Initially, they are all white.
...
- If the new patch is white, yello or blue, the vant colors the patch black and turns right 90 degrees.

- If the new patch is black, grey or green, the vant colors the patch white and turns left 90 degrees.
